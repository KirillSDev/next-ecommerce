...
export const products: IProduct[] = [
    ...
    {
        id: 5,
        name: 'Mini rolls with smoked salmon',
        slug: 'mini_rolls_with_smoked_salmon',
        price: 3,
        category: 'rolls',
    ...
    {
        id: 6,
        name: 'California rolls with sesame seeds',
        slug: 'california_rolls_with_sesame_seeds',
        price: 5.2,
        category: 'rolls',
    ...
    {
        id: 7,
        name: 'Mini rolls with cucumbers',
        slug: 'mini_rolls_with_cucumbers',
        price: 2.5,
        category: 'rolls',
    ...
    {
        id: 8,
        name: 'Mini rolls with cheese',
        slug: 'mini_rolls_with_cheese',
        price: 2.5,
        category: 'rolls',
    ...
    {
        id: 9,
        name: 'Mini rolls with eel',
        slug: 'mini_rolls_with_eel',
        price: 3.5,
        category: 'rolls',
    ...
    {
        id: 10,
        name: 'Philadelphia mini rolls',
        slug: 'philadelphia_mini_rolls',
        price: 4,
        category: 'rolls',
    ...
    {
        id: 11,
        name: 'Year of the tiger rolls',
        slug: 'year_of_the_tiger_rolls',
        price: 4,
        category: 'rolls',
    ...
    {
        id: 13,
        name: 'Green Philadelphia in caviar',
        slug: 'green_philadelphia_in_caviar',
        price: 4.2,
        category: 'rolls',
    ...
    {
        id: 16,
        name: 'California rolls with salmon',
        slug: 'california_rolls_with_salmon',
        price: 5,
        category: 'rolls',
    ...
    {
        id: 17,
        name: 'Canada rolls with salmon',
        slug: 'canada_rolls_with_salmon',
        price: 3.8,
        category: 'rolls',
    ...
    {
        id: 19,
        name: 'Philadelphia rolls with shrimp',
        slug: 'philadelphia_rolls_with_shrimp',
        price: 3.5,
        category: 'rolls',
    ...
    {
        id: 21,
        name: 'Philadelphia Duo rolls',
        slug: 'philadelphia_duo_rolls',
        price: 3.5,
        category: 'rolls',
    ...
    {
        id: 23,
        name: 'Canada rolls with cheese',
        slug: 'canada_rolls_with_cheese',
        price: 4.2,
        category: 'rolls',
    ...
    {
        id: 24,
        name: 'Rolls with smoked salmon',
        slug: 'rolls_with_smoked_salmon',
        price: 3.9,
        category: 'rolls',
    ...
    {
        id: 25,
        name: 'Sushi with chuka',
        slug: 'sushi_with_chuka',
        price: 1.7,
        category: 'sushi',
    ...
    {
        id: 26,
        name: 'Spicy sushi with crab',
        slug: 'spicy_sushi_with_crab',
        price: 1.6,
        category: 'sushi',
    ...
    {
        id: 27,
        name: 'Spicy sushi with salmon',
        slug: 'spicy_sushi_with_salmon',
        price: 1.8,
        category: 'sushi',
    ...
    {
        id: 28,
        name: 'Spicy sushi with eel',
        slug: 'spicy_sushi_with_eel',
        price: 1.8,
        category: 'sushi',
